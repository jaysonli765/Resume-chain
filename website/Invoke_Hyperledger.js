module.exports = async function Invoke_Hyperledger(_function_name, _key, _time, _workExp, _eduExp, _contact) {
    ...
    try {
        ...
        await contract1.submitTransaction(_function_name, _key, _time, `{"workExp":"${_workExp}","eduExp":"${_eduExp}","contact":"${_contact}"}`);

        // await contract1.submitTransaction(_function_name, _key, _time, `{"workExp":"${_workExp}"`);

        await gateway.disconnect();

        return [_key, _time, _workExp, _eduExp, _contact]
